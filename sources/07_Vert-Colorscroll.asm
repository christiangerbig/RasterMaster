...
; **** Vert-Colorscroll4 *****
  moveq   #FALSE,d1
  move.w  d1,vcs4_state(a3)
  moveq   #TRUE,d0
  move.w  d0,vcs4_switch_table_start(a3)

; **** Vert-Colorscroll5 *****
  move.w  d1,vcs5_state(a3)
...
eh_start_vert_colorscroll4
  moveq   #TRUE,d0
  move.w  d0,vcs4_state(a3)  ;Vert-Colorscroll4 an
...
eh_start_vert_colorscroll5
  moveq   #FALSE,d0
  move.w  d0,vcs4_state(a3)  ;Vert-Colorscroll4 aus
  moveq   #TRUE,d0
  move.w  d0,vcs5_state(a3)  ;Vert-Colorscroll5 an
  move.w  d0,bfi_state(a3)   ;Blind-Fader-In an
  rts
  CNOP 0,4
