...
init_colors
	...
	CPU_LOAD_COLORMAP_HIGH COLOR00,16,spr_rgb8_color_table

	CPU_SELECT_COLOR_LOW_BANK 2
	CPU_LOAD_COLORMAP_LOW COLOR00,16,spr_rgb8_color_table
	rts
