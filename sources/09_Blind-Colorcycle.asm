...
DDFSTOPBITS                EQU DDFSTOP_standard_min
  ENDC
...
extra_memory_size          EQU bcc_5242_switch_table_size*BYTESIZE
...
blind_colorcycle5242
  movem.l a4-a6,-(a7)
  move.w  bcc_5242_step2_angle(a3),d3 ;Winkel holen
  move.w  d3,d0              ;retten
  move.w  bcc_5242_switch_table_start(a3),d4 ;Startwert in Farbtabelle holen
  ...
  move.w  d0,bcc_5242_switch_table_start(a3) ;retten
  ...
  lea     sine_table,a5      ;Sinus-Tabelle
...
; ----------------------------------
  CNOP 0,4
pf1_color_table
  INCLUDE "Daten:Asm-Sources.AGA/RasterMaster/colortables/0a_bcc5242_Colorgradient.ct"
