...
bf_copy_buffer_loop
	...
	move.l	d0,d2		
	IFEQ tb31612_quick_clear_enabled
		move.w	a2,cl2_ext7_BPLCON3_colormap_high-cl2_ext7_COLOR31_high(a1) ; restore CMOVE
	ELSE
		move.w	a2,cl2_ext7_BPLCON3_colormap_high-cl2_ext7_COLOR00_high(a1) ; restore CMOVE
	ENDC
	...
	IFEQ tb31612_quick_clear_enabled
		move.w	a4,cl2_ext7_BPLCON3_colormap_low-cl2_ext7_COLOR31_high-cl2_extension7_size(a1) ; restore CMOVE
	ELSE
		move.w	a4,cl2_ext7_BPLCON3_colormap_low-cl2_ext7_COLOR00_high-cl2_extension7_size(a1) ; restore CMOVE
	ENDC
