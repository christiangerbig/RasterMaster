...
init_colors
	...
	IFEQ tb_quick_clear_enabled
		...
		CPU_LOAD_COLORMAP_HIGH COLOR31,1,pf1_rgb8_color_table
		CPU_SELECT_COLOR_LOW_BANK 7,bplcon3_bits4
		CPU_LOAD_COLORMAP_LOW COLOR31,1,pf1_rgb8_color_table
	ENDC
	rts
...
cl2_init_copperlist
	...
	COP_INIT_BPLCON4_CHUNKY cl2,cl2_hstart1,cl2_vstart1,cl2_display_x_size,cl2_display_y_size,TRUE,tb_quick_clear_enabled,FALSE,NOOP<<16
